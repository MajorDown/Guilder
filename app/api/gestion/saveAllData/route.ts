...
export async function GET(request: Request) {
  console.log(`api/god/saveAllData ~> Requète de récupération des noms de chaque guilde`);
  try {
    // CONNEXION A LA DB
    ...
    if (!IsGodConnected  || IsGodConnected !== "true") {
      console.log(`api/god/saveAllData ~> God non connecté`);
    ...
    // SI ERREUR
      console.log(`api/god/saveAllData ~> error :`, error);
