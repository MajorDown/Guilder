            ...
            <section className="section_right">
                <div id="section_mentions_legales" className="section_content">
                    ...
                    <div>
                        ...
                        <h3>5. Engagements des utilisateurs</h3>
                        ...
                        <h4>Responsabilité de Agriguilder :</h4>
                        <ul>
