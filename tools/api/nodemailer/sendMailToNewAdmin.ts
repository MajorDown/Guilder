...
async function sendMailToNewAdmin(admin: Admin, newPassword: string) {
    ...
    const mailOptions = {
        from: '"Guilder - Application de collaboration" <guilder.app@gmx.fr>',
        to: admin.mail,
        subject: 'Bienvenue sur Guilder !',
        html: /*html*/`
            <div style="font-family: monospace">
                <h1 style="margin-left: 50px; margin-bottom: 30px">Bienvenue sur Guilder, l'application d'entraide pour les collectifs !</h1>
                <div style="margin: 0 auto">
                    <p>Bonjour ${admin.name},</p>
                    <p>Un administrateur de la guilde "${admin.guild}" vous a ajouté en tant que nouvel admin !</p>
                    <p>Toute nos félicitations, donc... et bienvenue au sein de Guilder !</p>
                </div>
                ...
                <p style="margin-top: 10px">Vous pouvez dès à présent vous rendre sur votre compte en vous rendant à l'adressse <a href="https://www.guilderapp.fr/connexion">https://www.guilderapp.fr/connexion</a></p>
                <p>À bientôt sur Guilder !</p>
            </div>
