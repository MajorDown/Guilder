...
const SeventhSection = (): JSX.Element => {
    return (<WhiteSection id={Style.SeventhSection}>
        ...
        <div className={Style.testimonialContainer}>
            ...
            <div id={Style.testimonial}>
                ...
                <p><span>Nous avons testé Agriguilder</span> : l'application facilite vraiment la gestion des échanges de mat
                ériel et de travail. Nous l'avons adopté, et nous le recommandons à 100%.</p>
